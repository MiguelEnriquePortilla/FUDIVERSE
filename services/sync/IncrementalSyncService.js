// services/sync/IncrementalSyncService.js
...
class IncrementalSyncService {
  ...
  async syncTransactions(dateFrom, dateTo) {
    try {
  ...
  async syncCashShifts(dateFrom, dateTo) {
    try {
      ...
      console.error('Error syncing cash shifts:', error.message);
      this.stats.errors.push(`Cash shifts: ${error.message}`);
    }
  }

  // Sincronizar clientes nuevos
  async syncNewClients(fromDate) {
    try {
